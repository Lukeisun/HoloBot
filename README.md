# HoloBot! 
## I'm currently working on making the bot so all that needs to be done is you just simply invite the bot to your server! Progress is going to be slow as midterms are coming up but I will do my best. Use release v1.0 if you wish to use the bot, current changes may not be fully functional.
